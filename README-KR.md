> [!NOTE]
> 다음 한국어 콘텐츠는 DeepL에서 번역한 것으로 정확성을 보장하지 않을 수 있습니다. 영어 또는 중국어 사용설명서 파일을 참조하세요.
...
이 글꼴은 구두점 너비를 선택하는 데 사용되는 유니코드 변형 시퀀스를 지원합니다. [자세한 내용은 여기를 클릭하세요](/documentation/uvs.pdf).
...
- [IICore](https://github.com/NightFurySL2001/CJK-character-count/blob/master/iicore-han.txt)의 모든 한중일 표의문자(9,810자);
...
- 일부 한자 글리프는 [@Steve-Yuu](https://github.com/Steve-Yuu)가 개발한 [Yshi 펜서체](https://github.com/Steve-Yuu/YshiPen-Shuti)에서 차용했습니다.
